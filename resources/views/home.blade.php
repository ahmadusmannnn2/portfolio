...
@section('content')
  <section class="home" id="home">
    ...
    <h3>And I'm a <span class="multiple-text"
      data-roles="{{ $contents['home_roles']->value ?? 'UI/UX Designer' }}"></span></h3>
    <p>
  ...
  <section class="contact" id="contact">
    ...
    @if(session('success'))
    <div
    style="padding: 1rem; margin-bottom: 2rem; border-radius: 0.8rem; background: #698342; color: #fffae6; text-align: center;">
    {{ session('success') }}
    </div>
    @endif

<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- === INI MENU BARU UNTUK DESKTOP === --}}
                    <x-nav-link :href="route('admin.messages.index')"
                        :active="request()->routeIs('admin.messages.index')">
                        {{ __('Pesan Masuk') }}
                    </x-nav-link>

                    <x-nav-link :href="route('admin.social_links.index')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.content.index')"
                :active="request()->routeIs('admin.content.index')">
                {{ __('Kelola Tampilan') }}
            </x-responsive-nav-link>

            {{-- === INI MENU BARU UNTUK MOBILE === --}}

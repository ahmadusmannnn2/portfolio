    ...
    <x-input-error :messages="$errors->get('category_id')" class="mt-2" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="image" :value="__('Ganti Gambar (Opsional)')" />
                             @if($portfolio->image)
                                <img src="{{ asset('storage/'.$portfolio->image) }}" width="120" alt="" class="rounded my-2">
                            @endif
                        ...
                        <div class="flex items-center justify-end mt-4">
                             <a href="{{ route('admin.portfolios.index') }}" class="text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                {{ __('Batal') }}
                            </a>

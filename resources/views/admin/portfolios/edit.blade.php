                    ...
                    <form action="{{ route('admin.portfolios.update', $portfolio->id) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category_id"
                                    id="category_id"
                                    class="block mt-1 w-full border-gray-300 focus:border-theme-main focus:ring-theme-main rounded-md shadow-sm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 mb-2">
                                <img src="{{ asset('storage/' . $portfolio->image) }}"
                                     alt="{{ $portfolio->title }}"
                                     class="rounded-md h-32 object-contain">
                            </div>

                            {{-- Label kustom --}}
                            <label for="image"
                                   class="inline-flex items-center px-4 py-2 bg-theme-secondary text-theme-text rounded-lg shadow-sm tracking-wide uppercase border border-transparent cursor-pointer hover:bg-theme-main hover:text-white mt-2">
                                ...
                                <span id="image-label-text" class="text-base leading-normal">
                                    Pilih Gambar Baru
                                </span>
                                <input id="image"
                                       type="file"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            input.addEventListener('change', function() {
                if (input.files && input.files.length > 0) {
                    ...
                    labelText.textContent = 'Pilih Gambar Baru';
                }
            });
        });
    </script>

                        ...
                        <div class="mb-4">
                            ...
                            >
                                <svg class="w-5 h-5 mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0
                                         1 4.52-2.59A4.98 4.98 0 0 1 17 
                                         8c0 .38-.04.74-.12 1.1zM11 11h3l-4 4-4-4h3V3h2v8z"/>
                                </svg>
                                <span id="thumbnail_image-label-text" class="text-base leading-normal">
                                    {{ $certificate->thumbnail_path ? basename($certificate->thumbnail_path) : 'Pilih gambar...' }}
                                </span>
                                <input
                                    id="thumbnail_image"
                                    type="file"
                            ...
                            >
                                <svg class="w-5 h-5 mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path d="M16.88 9.1A4 4 0 0 1 16 
                                         17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 
                                         4.52-2.59A4.98 4.98 0 0 1 17 
                                         8c0 .38-.04.74-.12 1.1zM11 11h3l-4 4-4-4
                                         h3V3h2v8z"/>
                                </svg>
                                <span id="file_pdf-label-text" class="text-base leading-normal">
                                    {{ $certificate->file_path ? basename($certificate->file_path) : 'Pilih file PDF...' }}
                                </span>
                                <input
                                    id="file_pdf"
                                    type="file"

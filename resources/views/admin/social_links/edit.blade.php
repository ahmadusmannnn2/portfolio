                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.social_links.update', $socialLink->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $socialLink->name)" required />
                        </div>
                        <div class="mb-4">
                            <x-input-label for="url" value="URL Lengkap" />
                            <x-text-input id="url" class="block mt-1 w-full" type="url" name="url" :value="old('url', $socialLink->url)" required />
                        </div>
                        <div class="mb-4">
                            <x-input-label for="icon_class" value="Kelas Ikon BoxIcons (e.g., bx bxl-whatsapp)" />
                            <x-text-input id="icon_class" class="block mt-1 w-full" type="text" name="icon_class" :value="old('icon_class', $socialLink->icon_class)" required />

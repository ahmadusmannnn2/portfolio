                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="short_description" id="short_description" rows="3" class="block mt-1 w-full border-gray-300 focus:border-theme-main focus:ring-theme-main rounded-md shadow-sm">{{ old('short_description', $service->short_description) }}</textarea>
                        </div>
                        <div class="mb-4">
                            <x-input-label for="long_description" value="Deskripsi Lengkap (Tampil di halaman detail)" />
                            <textarea name="long_description" id="long_description" rows="6" class="block mt-1 w-full border-gray-300 focus:border-theme-main focus:ring-theme-main rounded-md shadow-sm">{{ old('long_description', $service->long_description) }}</textarea>
                        </div>
